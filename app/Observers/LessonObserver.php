...
class LessonObserver
{
        ...
        // este metodo se va activar solo cuando tratemos de crear algo de la tabla lessons
        public function creating(Lesson $lesson){
            ...
            if($platform_id == 1){
                ...
                // este metodo se va activar solo cuando tratemos de actualzar algo de la tabla lessons
        ...
        public function deleting(Lesson $lesson){
            if($lesson->resource){
                // si esta leccion tiene un recurso - primero elimina de la carpeta resources
...
// este observer sirve como escucha de los cambios, cambiara el iframde de los video segun sea el caso