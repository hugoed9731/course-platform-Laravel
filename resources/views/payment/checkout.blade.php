    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 py-12">
        ...
        <div class="card text-gray-600">
            <div class="card-body">
                ...
                <p class="text-sm mt-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. In, provident animi! Animi culpa modi eaque repudiandae nihil ut dolorum sint voluptas natus earum nemo, suscipit quis molestias at voluptatum explicabo. <a class="text-read-500 font-bold" href="">Términos y condiciones</a> </p>
            </div>
        </div>
    </div>
</x-app-layout>