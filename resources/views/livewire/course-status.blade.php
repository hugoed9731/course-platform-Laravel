    ...
    <div class="container grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div class="lg:col-span-2">
            ...
            <h1 class="text-3xl text-gray-600 font-bold mt-4">
                {{$current->name}}
                {{-- de esta manera no nos devuelve el codigo, ya que es asi por seguridad le quitamos eso --}}
            </h1>
            {{-- verificar si esta leccion tienen descripcion --}}
            @if ($current->description)
                {{-- esto solo se va a mostrar si existiera una opcion para esa descripcion --}}
            ...
            <div class="card mt-2">
                <div class="card-body flex text-gray-500 font-bold">
                    ...
                    @if ($this->previous)
                    {{-- si existe algo en la propiedad previous muestra esta etiqueta --}}
            ...
            <div class="card-body">
                ...
                <div class="flex items-center">
                    <figure>
                        ...
                        {{-- esta relación me trae al registro del maestro, img y etc --}}
                    </figure>

                    <div>
                        <p>{{$course->teacher->name}}</p>
                        <a class="text-blue-500 text-sm" href="">{{'@' . Str::slug($course->teacher->name, '')}}</a>
                        {{-- '' - las comillas quitan los espacios del slug --}}
                    </div>
                </div>
                            ...
                            <ul>
                                ...
                                @foreach ($section->lessons as $lesson)
                                    <li class="flex">
                                        ...
                                        {{-- cuando completed, mande true se va a ejecutar lo que esta dentro de esta condiconal --}}
