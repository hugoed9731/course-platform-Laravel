    ...
    <x-table-responsive>
        ...
        <div class="px-6 py-4 flex">
            <input wire:keydown="limpiar_page" wire:model="search"
                class="flex-1 h-10 border border-transparent rounded shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-transparent ..."
      ...
      @if ($courses->count())
      {{-- si por lo menos hay un registro se va a mostrar este contenido --}}
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                    <div class="flex items-center">
                        <div class="flex-shrink-0 h-10 w-10">
                            ...
                            @else
                            <img class="h-10 w-10 rounded-full object-cover object-center" src="https://images.pexels.com/photos/5940721/pexels-photo-5940721.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" alt="">
                            @endisset
                        </div>
                        <div class="ml-4">
