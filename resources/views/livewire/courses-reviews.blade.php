<section class="mt-4">
    ...
    @can('enrolled', $course)
        <article class="mb-4">
            ...
            @can('valued', $course)
            <textarea wire:model="comment" class="w-full border-blue-200 rounded focus:outline-none focus:ring-blue-300"  rows="3" placeholder="Ingrese una reseña del curso"></textarea>
            ...
            <div class="flex">
                ...
                <ul class="flex items-center">
                    ...
                    <li class="mr-1 cursor-pointer" wire:click="$set('rating', 1)"><i
                        {{-- se cambia depende de lo que tenga almacenado en $rating --}}
                            class="fas fa-star text-{{$rating >=1 ? 'yellow' : 'gray'}}-300"></i></li>
                    <li class="mr-1 cursor-pointer" wire:click="$set('rating', 2)"><i
                            class="fas fa-star text-{{$rating >=2 ? 'yellow' : 'gray'}}-300"></i></li>
                    <li class="mr-1 cursor-pointer"  wire:click="$set('rating', 3)"><i
                            class="fas fa-star text-{{$rating >=3 ? 'yellow' : 'gray'}}-300"></i></li>
                    <li class="mr-1 cursor-pointer" wire:click="$set('rating', 4)"><i
                            class="fas fa-star text-{{$rating >=4 ? 'yellow' : 'gray'}}-300"></i></li>
                    <li class="mr-1 cursor-pointer" wire:click="$set('rating', 5)"><i
                            class="fas fa-star text-{{$rating ==5 ? 'yellow' : 'gray'}}-300"></i></li>
                </ul>
            </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            {{-- mostramos todas las valoraciones --}}
